      ...
      <div className="flex flex-col md:flex-row items-center">
        <div className="text-center md:pr-8 md:border-r md:border-gray-200 dark:md:border-gray-700">
          ...
          <div className="text-gray-600 dark:text-gray-400">
            ({totalStudents.toLocaleString('vi-VN')} đánh giá)
          </div>
        </div>
        <div className="w-full md:pl-8 mt-6 md:mt-0 text-gray-700 dark:text-gray-300">
          Khóa học được đánh giá cao bởi học viên đã tham gia.
        </div>
      </div>
    </div>
