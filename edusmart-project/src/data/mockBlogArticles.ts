...
// DATA MỚI (KHỚP VỚI APIDOCS)
export const allArticles: Article[] = [
  {
    id: 1,
    slug: '10-meo-hoc-ielts-speaking-hieu-qua',
    title: '10 Mẹo học IELTS Speaking hiệu quả',
    subtitle: 'Cải thiện kỹ năng nói của bạn một cách nhanh chóng.',
    content: 'Nội dung chi tiết của bài viết...',
    writer: 'Admin EduSmart',
    keywords: 'ielts, speaking, tips',
    views: 1520,
    publishDate: '2025-11-15T09:00:00Z',
  },
  {
    id: 2,
    slug: 'cach-phan-biet-thi-hien-tai-don-va-tiep-dien',
    title: 'Cách phân biệt thì Hiện tại đơn và Tiếp diễn',
    subtitle: 'Lỗi ngữ pháp cơ bản mà nhiều người hay mắc phải.',
    content: 'Nội dung chi tiết của bài viết...',
    writer: 'Văn An',
    keywords: 'grammar, english, basic',
    views: 2800,
    publishDate: '2025-11-10T14:30:00Z',
  },
  {
    id: 3,
    slug: '5-sai-lam-thuong-gap-trong-toeic-listening',
    title: '5 Sai lầm thường gặp trong TOEIC Listening',
    subtitle: 'Đừng để mất điểm oan ở những câu hỏi dễ.',
    content: 'Nội dung chi tiết của bài viết...',
    writer: 'Admin EduSmart',
    keywords: 'toeic, listening, common-mistakes',
    views: 950,
    publishDate: '2025-11-05T08:00:00Z',
  },
];

// (Các data cũ về category, sidebar... đã bị xóa vì không có trong APIDocs)