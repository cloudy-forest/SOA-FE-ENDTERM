...
// ==========================
// MOCK DETAIL DATA (chỉ để làm đẹp UI, BE chưa có)
// ==========================

export const mockOutcomes: Outcome[] = [
  {
    id: 1,
    text: 'Nắm vững toàn bộ từ vựng và ngữ pháp cho band 6.5+ IELTS.',
  },
  {
    id: 2,
    text: 'Chiến thuật làm bài Reading và Listening tối ưu hóa điểm số.',
  },
  {
    id: 3,
    text: 'Kỹ năng Paraphrasing và phát triển ý tưởng cho Speaking Task 2.',
  },
  {
    id: 4,
    text: 'Viết thành thạo 7 dạng bài trong Writing Task 1.',
  },
  {
    id: 5,
    text: 'Cấu trúc bài luận Writing Task 2 đạt điểm cao.',
  },
];

export const mockCurriculum: CurriculumSection[] = [
  {
    id: 1,
    title: 'Phần 1: Nền tảng Từ vựng (Vocabulary)',
    lessons: [
      {
        id: 101,
        title: 'Bài 1: Chủ đề Education & Work',
        durationMinutes: 25,
        isFreePreview: true,
      },
      {
        id: 102,
        title: 'Bài 2: Chủ đề Environment & Energy',
        durationMinutes: 30,
        isFreePreview: false,
      },
      {
        id: 103,
        title: 'Bài 3: Chủ đề Health & Lifestyle',
        durationMinutes: 28,
        isFreePreview: false,
      },
    ],
  ...
  {
    id: 2,
    title: 'Phần 2: Kỹ năng Nghe (Listening)',
    lessons: [
      {
        id: 201,
        title: 'Bài 1: Dạng bài Multiple Choice',
        durationMinutes: 40,
        isFreePreview: true,
      },
      {
        id: 202,
        title: 'Bài 2: Dạng bài Map/Diagram Labeling',
        durationMinutes: 35,
        isFreePreview: false,
      },
    ],
  ...
  {
    id: 3,
    title: 'Phần 3: Kỹ năng Đọc (Reading)',
    lessons: [
      {
        id: 301,
        title: 'Bài 1: Skimming và Scanning',
        durationMinutes: 20,
        isFreePreview: false,
      },
      {
        id: 302,
        title: 'Bài 2: Dạng bài T/F/NG',
        durationMinutes: 45,
        isFreePreview: false,
      },
    ],
...
export const mockReviews: CourseReview[] = [
  {
    ...
    rating: 5,
    comment:
      'Khóa học rất chi tiết, giáo viên dạy dễ hiểu. Mình đã tăng 1.0 band sau 3 tháng!',
  ...
  },
  {
    ...
    rating: 4,
    comment:
      'Nội dung tốt, bài tập nhiều. Tuy nhiên phần Speaking nên có thêm bài luyện tập 1-1.',
...
export const mockTestimonials: Testimonial[] = [
  {
    id: 1,
    quote:
      'Đây là khóa học IELTS tốt nhất mình từng tham gia. Lộ trình rõ ràng, giáo viên tận tâm.',
    user: 'Nguyễn An',
    title: 'Học viên 7.5 IELTS',
  },
  {
    id: 2,
    quote:
      'Kỹ năng Writing của mình đã cải thiện rõ rệt chỉ sau 1 tháng. Cảm ơn EduSmart!',
    user: 'Lê Bảo',
    title: 'Học viên 7.0 IELTS',
  },
  {
    id: 3,
    quote:
      'Phần từ vựng và bài tập thực hành rất đa dạng, không bị nhàm chán.',
    user: 'Phạm Chi',
    title: 'Học viên 6.5 IELTS',
  },
];

export const mockFeedbackImages: FeedbackImage[] = [
  {
    id: 1,
    url: 'https://via.placeholder.com/300x400.png?text=Feedback+1',
    alt: 'Feedback 1',
  },
  {
    id: 2,
    url: 'https://via.placeholder.com/300x400.png?text=Feedback+2',
    alt: 'Feedback 2',
  },
  {
    id: 3,
    url: 'https://via.placeholder.com/300x400.png?text=Certificate+1',
    alt: 'Certificate 1',
  },
];
